...
configure_services() {
  ...
  sed \
    ...
    -e "s/\${MATRIX_TURN_LISTENING_PORT}/${MATRIX_TURN_LISTENING_PORT:-3478}/g" \
    -e "s/\${MATRIX_TURN_TLS_LISTENING_PORT}/${MATRIX_TURN_TLS_LISTENING_PORT:-5349}/g" \
    -e "s/\${MATRIX_TURN_ALT_LISTENING_PORT}/${MATRIX_TURN_ALT_LISTENING_PORT:-0}/g" \
    -e "s/\${MATRIX_TURN_ALT_TLS_LISTENING_PORT}/${MATRIX_TURN_ALT_TLS_LISTENING_PORT:-0}/g" \
